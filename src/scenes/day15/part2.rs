...
impl bevy::app::Plugin for Plugin {
    fn build(&self, app: &mut bevy::prelude::App) {
        ...
        .add_systems(
            Update,
            build_ui
                .run_if(in_state(Part::Part2).and(in_state(VisualizationState::<15>::WaitingUi))),
        );
    }
}
...
fn build_ui(
    ...
    commands.insert_resource(Warehouse::from_input(&input, true));
