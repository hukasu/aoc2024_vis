...
#[source(SceneStates = SceneStates::Day(25))]
pub enum InputState {
    #[default]
    NotLoaded,
    Loaded,
...
impl ComputedStates for VisualizationState {
    ...
    fn compute(sources: Self::SourceStates) -> Option<Self> {
        match sources {
            (SceneStates::Day(25), InputState::NotLoaded, _) => Some(Self::WaitingInput),
            (SceneStates::Day(25), InputState::Loaded, UiState::NotLoaded) => Some(Self::WaitingUi),
            (SceneStates::Day(25), InputState::Loaded, UiState::Loaded) => Some(Self::Ready),
            _ => None,
        }
    }
}
