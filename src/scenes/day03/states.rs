...
#[source(SceneStates = SceneStates::Day(3))]
pub enum States {
    #[default]
    Part1,
    Part2,
...
impl ComputedStates for VisualizationState {
    ...
    fn compute(sources: Self::SourceStates) -> Option<Self> {
        match sources {
            (SceneStates::Day(3), InputState::NotLoaded, _) => Some(Self::WaitingInput),
            (SceneStates::Day(3), InputState::Loaded, UiState::NotLoaded) => Some(Self::WaitingUi),
            (SceneStates::Day(3), InputState::Loaded, UiState::Loaded) => Some(Self::Ready),
            _ => None,
        }
    }
}
